...
enum HotkeyFormatter {
    static func binding(from event: NSEvent) -> HotkeyBinding? {
        ...
        return HotkeyBinding(keyCode: UInt32(keyCode), modifiers: modifiers)
    }
    ...
    static func displayString(for binding: HotkeyBinding) -> String {
        ...
        parts.append(keyName(for: UInt16(binding.keyCode)))
        return parts.joined()
    }
